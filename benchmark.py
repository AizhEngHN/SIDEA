from basic import Ackley, Griewank, Rastrigin, Rosenbrock, \
...
def mat2python(filename, flags):
    ...
    parameters = []
    for i, flag in enumerate(flags):    # enumerate 把flags 变为 [(0,'GO_Task1'),(1,'GO_Task2'),(2,'Rotation_Task1'),(3,'Rotation_Task2')]
        if flag!= None:
            name = names[i]
...
def CI_HS(filename = '\Tasks\CI_H.mat'):
    ...
    tasks = [Task(50, Task1.fnc, -100, 100),          # D = 50 维度，函数，下界，上界
